...
import Slide16Results from '@/lib/slides/16-results';
import Slide17Comparison from '@/lib/slides/17-comparison';
import Slide18Merci from '@/lib/slides/18-merci';
