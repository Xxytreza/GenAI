...
export const SLIDES: SlideConfig[] = [
  ...
  { id: 13, title: "Prédiction Mathématique", subtitle: "ε_θ(xₜ, t)", bgIntensity: 70, bgColor: "#00f0ff" },
  { id: 14, title: "Formule de Sampling", subtitle: "x_{t-1} et processus", bgIntensity: 70, bgColor: "#8b5cf6" },
  { id: 15, title: "Visualisation", subtitle: "Reverse Denoising", bgIntensity: 100, bgColor: "#ff00aa" },
  { id: 16, title: "Animation Reverse", subtitle: "Débruitage progressif", bgIntensity: 90, bgColor: "#ff00aa" },
  { id: 17, title: "Évaluation", subtitle: "Mesurer la qualité", bgIntensity: 80, bgColor: "#00f0ff" },
